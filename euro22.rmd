...
```{r LUO_maalintekijataulu, eval=FALSE, warning=FALSE, include=FALSE}
...
```{r TAYTA_maalintekijataulu, eval=FALSE, warning=FALSE, include=FALSE}
### sisalto
if (length(veikkaukset) > 0) {
...
```{r LUO_maalintekijataulu6, echo=FALSE, warning=FALSE}
...
```{r TAYTA_maalintekijataulu6, echo=FALSE, warning=FALSE}
## Versio 6:lle maalintekijalle (mm23)
### sisalto
if (length(veikkaukset) > 0) {
for (uu in 2:length(veikkaukset)) {
...
as.datatable(
    ...
    style = ~ style(color = "green", font.weight = "bold"))
            ...
            options = list(
                      ...
                      scrollX = TRUE,
                      scrollY = "460px", #y scrolli ja taulun pituus
                      #scrollCollapse = TRUE,
